...
public class FormuleMapperImpl implements FormuleMapper {
    ...
    @Override
    public Formule entityToModel(FormuleEntity formuleEntity, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
    ...
    @Override
    public FormuleEntity modelToEntity(Formule formule, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
    ...
    protected Image imageEntityToImage(ImageEntity imageEntity, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        ...
        image.setFormule( entityToModel( imageEntity.getFormule(), cycleAvoidingMappingContext ) );
    ...
    protected Reservation reservationEntityToReservation(ReservationEntity reservationEntity, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        ...
        reservation.setFormule( entityToModel( reservationEntity.getFormule(), cycleAvoidingMappingContext ) );
    ...
    protected ImageEntity imageToImageEntity(Image image, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        ...
        imageEntity.setFormule( modelToEntity( image.getFormule(), cycleAvoidingMappingContext ) );
    ...
    protected ReservationEntity reservationToReservationEntity(Reservation reservation, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        ...
        reservationEntity.setFormule( modelToEntity( reservation.getFormule(), cycleAvoidingMappingContext ) );
