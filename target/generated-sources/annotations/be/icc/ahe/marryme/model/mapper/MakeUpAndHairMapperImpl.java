...
@Generated(
    ...
    date = "2022-11-23T17:12:26+0100",
    comments = "version: 1.5.2.Final, compiler: javac, environment: Java 11.0.8 (Oracle Corporation)"
)
public class MakeUpAndHairMapperImpl implements MakeUpAndHairMapper {

    @Override
    public MakeUpAndHair entityToModel(MakeUpAndHairEntity makeUpAndHairEntity, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        MakeUpAndHair target = cycleAvoidingMappingContext.getMappedInstance( makeUpAndHairEntity, MakeUpAndHair.class );
        if ( target != null ) {
            return target;
        }
        ...
        cycleAvoidingMappingContext.storeMappedInstance( makeUpAndHairEntity, makeUpAndHair );

        makeUpAndHair.setServiceID( makeUpAndHairEntity.getServiceID() );
        makeUpAndHair.setNom( makeUpAndHairEntity.getNom() );
        makeUpAndHair.setAddress( addressEntityToAddress( makeUpAndHairEntity.getAddress(), cycleAvoidingMappingContext ) );
    ...
    @Override
    public MakeUpAndHairEntity modelToEntity(MakeUpAndHair makeUpAndHair, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        MakeUpAndHairEntity target = cycleAvoidingMappingContext.getMappedInstance( makeUpAndHair, MakeUpAndHairEntity.class );
        if ( target != null ) {
            return target;
        }
        ...
        cycleAvoidingMappingContext.storeMappedInstance( makeUpAndHair, makeUpAndHairEntity );

        makeUpAndHairEntity.setServiceID( makeUpAndHair.getServiceID() );
        makeUpAndHairEntity.setNom( makeUpAndHair.getNom() );
        makeUpAndHairEntity.setAddress( addressToAddressEntity( makeUpAndHair.getAddress(), cycleAvoidingMappingContext ) );
    ...
    @Override
    public MakeUpAndHair dtoToModel(GetShortMakeUpAndAirServiceDTO form) {
        if ( form == null ) {
            return null;
        }
        ...
        makeUpAndHair.setServiceID( form.getService_id() );
        makeUpAndHair.setDoHair( form.getDo_hair() );
        makeUpAndHair.setDoMakeUp( form.getDo_make_up() );
