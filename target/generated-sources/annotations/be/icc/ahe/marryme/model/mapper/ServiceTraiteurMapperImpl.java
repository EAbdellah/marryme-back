...
public class ServiceTraiteurMapperImpl implements ServiceTraiteurMapper {
    ...
    @Override
    public ServiceTraiteurEntity entityToModel(ServiceTraiteur serviceTraiteur) {
        ...
        serviceTraiteurEntity.setSociete( societeToSocieteEntity( serviceTraiteur.getSociete() ) );
    ...
    @Override
    public ServiceTraiteur modelToEntity(ServiceTraiteurEntity serviceEntity) {
        ...
        serviceTraiteur.setServiceID( serviceEntity.getServiceID() );
        serviceTraiteur.setNom( serviceEntity.getNom() );
        serviceTraiteur.setSociete( societeEntityToSociete( serviceEntity.getSociete() ) );
        serviceTraiteur.setFermetures( fermetureEntityCollectionToFermetureCollection( serviceEntity.getFermetures() ) );
        serviceTraiteur.setImage( imageEntityToImage( serviceEntity.getImage() ) );
        serviceTraiteur.setManOnly( serviceEntity.getManOnly() );
        serviceTraiteur.setWomanOnly( serviceEntity.getWomanOnly() );
