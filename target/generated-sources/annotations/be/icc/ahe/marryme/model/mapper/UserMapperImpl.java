...
public class UserMapperImpl implements UserMapper {
    ...
    @Override
    public UserEntity modelToEntity(User user, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
    ...
    @Override
    public User entityToModel(UserEntity userEntity, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
    ...
    protected ReservationEntity reservationToReservationEntity(Reservation reservation, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        ...
        reservationEntity.setUser( modelToEntity( reservation.getUser(), cycleAvoidingMappingContext ) );
    ...
    protected Reservation reservationEntityToReservation(ReservationEntity reservationEntity, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        ...
        reservation.setUser( entityToModel( reservationEntity.getUser(), cycleAvoidingMappingContext ) );
