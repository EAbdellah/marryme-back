...
public class MediaMapperImpl implements MediaMapper {
    ...
    @Override
    public Media entityToModel(MediaEntity mediaEntity, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        Media target = cycleAvoidingMappingContext.getMappedInstance( mediaEntity, Media.class );
        if ( target != null ) {
            return target;
        }
        ...
        cycleAvoidingMappingContext.storeMappedInstance( mediaEntity, media );

        media.setServiceID( mediaEntity.getServiceID() );
        media.setNom( mediaEntity.getNom() );
        media.setAddress( addressEntityToAddress( mediaEntity.getAddress(), cycleAvoidingMappingContext ) );
    ...
    @Override
    public MediaEntity modelToEntity(Media media, CycleAvoidingMappingContext cycleAvoidingMappingContext) {
        MediaEntity target = cycleAvoidingMappingContext.getMappedInstance( media, MediaEntity.class );
        if ( target != null ) {
            return target;
        }
        ...
        cycleAvoidingMappingContext.storeMappedInstance( media, mediaEntity );

        mediaEntity.setServiceID( media.getServiceID() );
        mediaEntity.setNom( media.getNom() );
        mediaEntity.setAddress( addressToAddressEntity( media.getAddress(), cycleAvoidingMappingContext ) );
    ...
    @Override
    public Media dtoToModel(GetShortMediaServiceDTO form) {
        if ( form == null ) {
            return null;
        }
        ...
        media.setServiceID( form.getService_id() );
        media.setIsPhoto( form.getIs_photo() );
        media.setIsVideo( form.getIs_video() );
