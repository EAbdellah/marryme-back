...
public class MediaMapperImpl implements MediaMapper {
    ...
    @Override
    public MediaEntity entityToModel(Media media) {
        if ( media == null ) {
            return null;
        }
        ...
        mediaEntity.setSociete( societeToSocieteEntity( media.getSociete() ) );
    ...
    @Override
    public Media modelToEntity(MediaEntity mediaEntity) {
        if ( mediaEntity == null ) {
            return null;
        }
        ...
        media.setSociete( societeEntityToSociete( mediaEntity.getSociete() ) );
