package be.icc.ahe.marryme.security.utility;
...
import static be.icc.ahe.marryme.constant.SecurityConstant.*;
...
public class JWTTokenProvider {
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(MARRY_ME_SPRL).build();
