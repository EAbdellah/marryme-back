...
public class SecurityConstant {
    ...
    public static final String[] PUBLIC_URLS = { "/api/user/hello","/api/user/login", "/api/user/register","/api/user/regitrationConfirm", "/api/user/image/**","/api/provider/allServices" };
