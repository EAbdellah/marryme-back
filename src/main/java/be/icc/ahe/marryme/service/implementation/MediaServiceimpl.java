...
public class MediaServiceimpl implements MediaService {
    ...
    public Media save(Media media) throws MediaDatabaseException {
        ...
        MediaEntity persistedMediaEntity = mediaDAO.save(MediaMapper.INSTANCE.modelToEntity(media,new CycleAvoidingMappingContext()));
        ...
        return MediaMapper.INSTANCE.entityToModel(persistedMediaEntity,new CycleAvoidingMappingContext());
    ...
    public Media findByID(Long id) throws MediaDatabaseException {
        ...
        return MediaMapper.INSTANCE.entityToModel(mediaEntity,new CycleAvoidingMappingContext());
    ...
    @Override
    public GetShortMediaServiceDTO getMediaByProvider(String ProviderEmail) {
        return mediaDAO.getMediaByProvider(ProviderEmail);
    }
}
